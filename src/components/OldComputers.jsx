  ...
  return (
    <group {...props} dispose={null}>
      <group name="Scene">
        ...
        />
        <TextOverlayShowAll
          onScreenClick={props.onScreenClick}
          hoveredId={hoveredId}
          onHover={setHoveredId}
        />
        <group name="Screen_A001" position={[-2.731, 0.629, -0.522]} rotation={[0, 1.087, 0]} {...hoverLink(navLinks[2])}>
          <mesh
            name="Cube018"
            castShadow
            receiveShadow
        ...
        <group name="Screen_B001" position={[-1.711, 3.015, -1.98]} rotation={[0, 1.002, 0]} {...hoverLink(navLinks[1])}>
          <mesh
            name="Cube014"
            castShadow
            receiveShadow
